...
angular.module('app', ['hello', 'github'])
  .controller('demoController', function($scope, helloFactory, github) {
    // helloFactory.sayGoodbye();
    github.getEvents().then(function(response) {
